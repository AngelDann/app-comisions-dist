...
1. **Find recent code changes**:
   ...
   ```
   If the project is not a git repository or history is unavailable, narrow scope using the paths the user cares about, file modification times, or the current diff.
...
Adapted from [claude-code-django](https://github.com/kjnez/claude-code-django) (`.claude/skills/docs-sync`).
